    ...
    <div class="container py-5">
      <div class="row">
        ...
        <div class="col-md-6 text-black text-left p-5" style="background-color:#fff">
          ...
          <br>
          <form class="" action="homepageUser.php">
...
<div class="py-5 bg-light text-dark">
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="card">
          <div class="card-body">
            <a href="animalCatalogIndividual.html"><img class="img-fluid w-100 p-0 m-0" src="https://i.pinimg.com/736x/25/37/5c/25375c3078ec819fbedd47baed27cb1c--husky-pomeranian-mix-teacup-husky-puppies.jpg">
            <hr>
            <h4>Sophie</h4></a>
