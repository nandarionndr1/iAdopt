<?php
    ...
    if(isset($_POST['accept'])){
        $col->update(array("status" => "Pending"), array( '$set'=>array("status" => "Approved")));
        $current = $col->findOne(array('id' => $id));
    }
    elseif(isset($_POST['reject'])){
        $col->remove(array("id" => $id));
    }
    $current = $col->findOne(array('id' => $id));
        ...
        <div class="col-md-9">
          <div class="card">
            ...
            <?php
              ...
              echo "<p><b>Status:</b> ".$current['status']."</p>";
            ?>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6" align="center">
          <ul class="pagination" align="center">
            <li class="page-item">
              <a class="page-link" href="acceptAdoptionApplication.php" aria-label="bACK"> <span aria-hidden="true">Go Back to List</span> <span class="sr-only">Next</span> </a>
            </li>
          </ul>
        </div>
      </div>
