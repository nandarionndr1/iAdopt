        ...
        <div class="col-md-6">
          <div class="card text-white p-5 bg-primary">
            <div class="card-body">
              ...
              <form action="PHPMailer/mail.php" method="POST" enctype="multipart/form-data">
                <div class="form-group"> <label>From email</label>
                  <input type="email" name="senderEmail" class="form-control" placeholder="Enter Email" required> </div>
                <div class="form-group"> <label>To email</label>
                  <input type="text" name="receiverEmail" class="form-control" placeholder="FullName" required> </div>
                <div class="form-group"> <label>Subject</label>
                  <input type="text" name="subject" class="form-control" placeholder="Password" required> </div>
                <div class="form-group"> <label>Message</label>
                  <input type="text" name="message" class="form-control" placeholder="Password" required> </div>
                  <hr>
                  <center><button type="submit" name="submit" class="btn btn-secondary btn-lg">Send message</button></center>
              </form>
            </div>
          </div>
        </div>
